        ...
        return [
            ...
            'DashboardSummary' => [
                ...
                'properties' => [
                    ...
                    'reorder_count' => ['type' => 'integer', 'description' => 'Products the intelligence engine says to reorder (forecast/velocity verdict, not the manual reorder_level).'],
                    'urgent_count' => ['type' => 'integer', 'description' => 'Subset of reorder_count that should be ordered today.'],
                    'out_of_stock_count' => ['type' => 'integer'],
                    'total_stock_units' => ['type' => 'integer'],
                    'total_stock_value' => ['type' => 'number', 'format' => 'float'],
                    'reorder_products' => ['type' => 'array', 'description' => 'Top 5 reorder recommendations, most urgent first.', 'items' => self::schemaRef('Recommendation')],
